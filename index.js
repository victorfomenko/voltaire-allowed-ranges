...
const limits = {
  ...
  'SAI-BCH': {
    limit: {
      buy: {
        quantity: { min: Big(0.1), max: Big(1000000) },
        price: { min: Big(0.0000001), max: Big(10) }
      },
      sell: {
        quantity: { min: Big(0.1), max: Big(1000000) },
        price: { min: Big(0.00000001), max: Big(10) }
    ...
    market: {
      buy: { min: Big(0.000001), max: Big(100) },
      sell: { min: Big(0.1), max: Big(1000000) }
    }
  },
  'BCH-USDH': {
    limit: {
      buy: {
        quantity: { min: Big(0.01), max: Big(1000) },
        price: { min: Big(1), max: Big(100000) }
      },
      sell: {
        quantity: { min: Big(0.00001), max: Big(1000) },
        price: { min: Big(0.01), max: Big(100000) }
      }
    },
    market: {
      buy: { min: Big(0.01), max: Big(100000) },
      sell: { min: Big(0.00001), max: Big(10000) }
    }
  }
};
...
limits['DROP-BCH'] = limits['SAI-BCH'];
